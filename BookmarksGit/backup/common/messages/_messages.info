...
my_message = {
	...
	### Brief: message_filter_type
	# Message filter key used in the message settings for users editing the 
	# display and frequency of messages within each filter group.
	# Note: Will be overwritten if another message_filter_type is provided by 
	#       effect 'send_interface_message' or 'send_interface_message_as_toast'
	# 	Default: Empty, and if empty won't show up in settings
	message_filter_type = <key>
	...
	# If not provided will automatically select sound based on display + style, see NPlayerMessage
	# 	Default: Generated by display and style
	...
	### Brief: flag ( keys )
	# Each entry adds a which can be used to further customize the look and
	# behaviour of your message. 
	#
