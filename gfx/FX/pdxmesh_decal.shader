	...
	MainCode PS_local
	{
		...
		[[
			PDX_MAIN
			{
				...
				// MOD(moat)
				#ifdef MOAT_MASK_BORDER_COLOR
					BorderPreLightingBlend  *= 1.0f - Diffuse.a;
					BorderPostLightingBlend *= 1.0f - Diffuse.a;
				#endif // MOAT_MASK_BORDER_COLOR
				// END MOD
...
# MOD(moat)
Effect MOAT_decal_local
{
	VertexShader = "VS_standard"
	PixelShader = "PS_local"
	
	Defines = { "TANGENT_SPACE_NORMALS" "MOAT_MASK_BORDER_COLOR" }
}

Effect MOAT_decal_local_mapobject
{
	VertexShader = "VS_mapobject"
	PixelShader = "PS_local"
